...
export const FloatingChromeButton = ({
  ...
  return (
    <button
      className={`touch-manipulation rounded-full border border-white/12 bg-slate-950/65 px-4 py-3 text-base font-semibold text-slate-100 shadow-[0_10px_30px_rgba(0,0,0,0.45)] backdrop-blur-2xl transition-all duration-200 ease-out hover:border-white/20 hover:bg-slate-900/80 active:scale-[0.97] ${className}`}
      type={type}
      aria-label={label}
      title={label}
      {...props}
