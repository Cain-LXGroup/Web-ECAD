...
export const LabelView = ({
  ...
  console.info("[LabelView] Rendering label-like item", { itemId: item.id, variant, selected, schematicTextSize });
  ...
  return (
    ...
    >
      <rect
        x={-16}
        y={-labelHeight * 0.6}
        width={item.text.length * (fontSize * 0.54) + 32}
        height={labelHeight}
        rx={16}
        fill={backgroundFill}
        stroke={selected ? kicadSchematicTheme.selection : "#4b5563"}
        strokeWidth={2}
      />
